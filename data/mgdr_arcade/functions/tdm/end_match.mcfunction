...
team leave @a
clear @a
execute unless score .alliegiancePoints arcadeRule matches 50.. if score .coalitionPoints arcadeRule matches 50.. run tellraw @a ["",{"translate": "mgdr_arcade.gamemode.message.end_match.team","color": "green"},{"translate": "mgdr_arcade.gamemode.message.end_match.coalition","color": "blue"},{"translate": "mgdr_arcade.gamemode.message.end_match.has_won_the_match","color": "green"}]
execute if score .alliegiancePoints arcadeRule matches 50.. unless score .coalitionPoints arcadeRule matches 50.. run tellraw @a ["",{"translate": "mgdr_arcade.gamemode.message.end_match.team","color": "green"},{"translate": "mgdr_arcade.gamemode.message.end_match.alliegiance","color": "red"},{"translate": "mgdr_arcade.gamemode.message.end_match.has_won_the_match","color": "green"}]
execute if score .alliegiancePoints arcadeRule > .coalitionPoints arcadeRule unless score .alliegiancePoints arcadeRule matches 50.. unless score .coalitionPoints arcadeRule matches 50.. run tellraw @a ["",{"translate": "mgdr_arcade.gamemode.message.end_match.team","color": "green"},{"translate": "mgdr_arcade.gamemode.message.end_match.alliegiance","color": "red"},{"translate": "mgdr_arcade.gamemode.message.end_match.has_won_the_match","color": "green"}]
execute if score .alliegiancePoints arcadeRule < .coalitionPoints arcadeRule unless score .alliegiancePoints arcadeRule matches 50.. unless score .coalitionPoints arcadeRule matches 50.. run tellraw @a ["",{"translate": "mgdr_arcade.gamemode.message.end_match.team","color": "green"},{"translate": "mgdr_arcade.gamemode.message.end_match.coalition","color": "blue"},{"translate": "mgdr_arcade.gamemode.message.end_match.has_won_the_match","color": "green"}]
execute if score .alliegiancePoints arcadeRule = .coalitionPoints arcadeRule unless score .alliegiancePoints arcadeRule matches 50.. unless score .coalitionPoints arcadeRule matches 50.. run tellraw @a ["",{"translate": "mgdr_arcade.gamemode.message.end_match.draw","color": "green"}]
execute if score .alliegiancePlayers arcadeRule matches 0 run tellraw @a ["",{"translate": "mgdr_arcade.gamemode.message.end_match.team","color": "green"},{"translate": "mgdr_arcade.gamemode.message.end_match.alliegiance","color": "red"},{"translate": "mgdr_arcade.gamemode.message.end_match.has_forfeited_the_match","color": "green"}]
