execute as @a[scores={arcade.plr_deaths=1..},tag=!forfeitedMatch] at @s if score .matchStarted arcadeRule matches 1.. run function mgdr_arcade:ffa/death
...
execute if score .matchStarted arcadeRule matches 1.. as @a[scores={a_match.playerKills=25..},limit=1] run function mgdr_arcade:ffa/end_match_for_player
