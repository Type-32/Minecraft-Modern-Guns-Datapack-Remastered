execute as @e[tag=Alliegiance,tag=CTOSpawnPoint,type=armor_stand,tag=ArcadeAsset,sort=random] at @s run function mgdr_arcade:respawn/cto/alliegiance_stacktrace_init_spawn
