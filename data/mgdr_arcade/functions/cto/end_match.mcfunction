...
team leave @a
clear @a
execute unless score .alliegiancePoints arcadeRule matches 200.. if score .coalitionPoints arcadeRule matches 200.. run tellraw @a ["",{"translate": "mgdr_arcade.gamemode.message.end_match.team","color": "green"},{"translate": "mgdr_arcade.gamemode.message.end_match.coalition","color": "blue"},{"translate": "mgdr_arcade.gamemode.message.end_match.has_won_the_match","color": "green"}]
execute if score .alliegiancePoints arcadeRule matches 200.. unless score .coalitionPoints arcadeRule matches 200.. run tellraw @a ["",{"translate": "mgdr_arcade.gamemode.message.end_match.team","color": "green"},{"translate": "mgdr_arcade.gamemode.message.end_match.alliegiance","color": "red"},{"translate": "mgdr_arcade.gamemode.message.end_match.has_won_the_match","color": "green"}]
execute if score .alliegiancePoints arcadeRule > .coalitionPoints arcadeRule unless score .alliegiancePoints arcadeRule matches 200.. unless score .coalitionPoints arcadeRule matches 200.. run tellraw @a ["",{"translate": "mgdr_arcade.gamemode.message.end_match.team","color": "green"},{"translate": "mgdr_arcade.gamemode.message.end_match.alliegiance","color": "red"},{"translate": "mgdr_arcade.gamemode.message.end_match.has_won_the_match","color": "green"}]
execute if score .alliegiancePoints arcadeRule < .coalitionPoints arcadeRule unless score .alliegiancePoints arcadeRule matches 200.. unless score .coalitionPoints arcadeRule matches 200.. run tellraw @a ["",{"translate": "mgdr_arcade.gamemode.message.end_match.team","color": "green"},{"translate": "mgdr_arcade.gamemode.message.end_match.coalition","color": "blue"},{"translate": "mgdr_arcade.gamemode.message.end_match.has_won_the_match","color": "green"}]
execute if score .alliegiancePoints arcadeRule = .coalitionPoints arcadeRule unless score .alliegiancePoints arcadeRule matches 200.. unless score .coalitionPoints arcadeRule matches 200.. run tellraw @a ["",{"translate": "mgdr_arcade.gamemode.message.end_match.draw","color": "green"}]
