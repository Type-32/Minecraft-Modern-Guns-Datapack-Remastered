...
scoreboard players set @s a_match.playerKillStreak 0
...
#execute if entity @s[team=coalition] run scoreboard players add .allegiancePoints arcadeRule 1
#execute if entity @s[team=allegiance] run scoreboard players add .coalitionPoints arcadeRule 1
