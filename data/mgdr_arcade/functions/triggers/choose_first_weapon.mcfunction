...
tellraw @s[scores={chooseWeapon1=15}] ["",{"translate": "mgdr_arcade.message.loadout.you_have_chosen","color": "yellow"},{"translate": "mgdr_arcade.message.loadout.cbs5","color": "green"},{"translate": "mgdr_arcade.message.loadout.as_your_first_weapon","color": "yellow"}]
