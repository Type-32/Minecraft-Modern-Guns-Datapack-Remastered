...
execute unless score .preparationTime arcadeRule matches 1.. if score .votedForTDM arcadeRule > .votedForFFA arcadeRule run function mgdr_arcade:tdm/start_match
execute unless score .preparationTime arcadeRule matches 1.. if score .votedForTDM arcadeRule < .votedForFFA arcadeRule run function mgdr_arcade:ffa/start_match
