...
execute if score .matchStarted arcadeRule matches 1.. if score .allegiancePoints arcadeRule > .coalitionPoints arcadeRule if score .matchTime arcadeRule matches ..0 run function mgdr_arcade:tdm/end_match
execute if score .matchStarted arcadeRule matches 1.. if score .allegiancePoints arcadeRule < .coalitionPoints arcadeRule if score .matchTime arcadeRule matches ..0 run function mgdr_arcade:tdm/end_match
