...
execute if score .matchStarted arcadeRule matches 1.. if score .alliegiancePoints arcadeRule matches 200.. unless score .coalitionPoints arcadeRule matches 200.. run function mgdr_arcade:cto/end_match
execute if score .matchStarted arcadeRule matches 1.. unless score .alliegiancePoints arcadeRule matches 200.. if score .coalitionPoints arcadeRule matches 200.. run function mgdr_arcade:cto/end_match
