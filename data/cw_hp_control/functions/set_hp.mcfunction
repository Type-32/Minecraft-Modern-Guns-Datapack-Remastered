...
execute if score .enableArcadeFunctions gamerule matches 1.. run tag @s remove hasAutoHealed
execute if score .enableArcadeFunctions gamerule matches 1.. run scoreboard players set @s hitTime 0
execute if score .enableArcadeFunctions gamerule matches 1.. run effect clear @s regeneration
