...
execute unless block ~ ~ ~ #mgdr:bullet_impact/glass unless block ~ ~ ~ #mgdr:bullet_impact/water unless block ~ ~ ~ #mgdr:bullet_impact/cloth unless block ~ ~ ~ #mgdr:bullet_impact/dirt unless block ~ ~ ~ #mgdr:bullet_impact/mud unless block ~ ~ ~ #mgdr:bullet_impact/wood
...
playsound mgdr:others.solid_bullet_impact block @a ~ ~ ~ 0.8