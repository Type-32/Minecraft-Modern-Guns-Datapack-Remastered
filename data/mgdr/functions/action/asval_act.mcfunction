...
execute if score noRecoil mgdr.gamerule matches ..0 run tp @s[tag=!haveGrip] ~ ~ ~ ~ ~-1.5
execute if score noRecoil mgdr.gamerule matches ..0 run tp @s[tag=haveGrip] ~ ~ ~ ~ ~-0.8

execute if score infiniteAmmo mgdr.gamerule matches ..0 run scoreboard players remove @s[gamemode=!creative] asval.ammo 1
