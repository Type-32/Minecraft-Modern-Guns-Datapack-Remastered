...
execute as @s[predicate=!mgdr:is_sneaking,tag=!haveSupressor] anchored eyes positioned ^ ^ ^1 if block ~ ~1 ~ air run particle campfire_cosy_smoke ^-.3 ^-.15 ^1.1 0 2 0 .07 0 force @s[scores={tgl_particle=0}]
...
execute as @s[predicate=!mgdr:is_sneaking] anchored eyes positioned ^ ^ ^1 if block ~ ~1 ~ air run particle flame ^-.3 ^-.15 ^1.1 0 0 0 .03 2 force @s[scores={tgl_particle=0}]
