...
execute as @s run playsound mgdr:vsg15.fire voice @a[distance=..40] ~ ~ ~ 10
...
execute if score @s vsg15.ammo matches ..0 at @s run playsound mgdr:common.empty player @s
