...
playsound mgdr:augpara.fire player @a[distance=..45] ~ ~ ~ 1000
playsound mgdr:augpara.fire.mech player @a[distance=..10] ~ ~ ~ 1
playsound mgdr:augpara.fire.bass player @a[distance=..30] ~ ~ ~ 10
