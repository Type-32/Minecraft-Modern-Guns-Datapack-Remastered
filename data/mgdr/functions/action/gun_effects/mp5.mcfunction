...
playsound mgdr:mp5.fire player @a[distance=..40] ~ ~ ~ 1000
playsound mgdr:mp5.fire.mech player @a[distance=..10] ~ ~ ~ 1
playsound mgdr:mp5.fire.bass player @a[distance=..35] ~ ~ ~ 1000
