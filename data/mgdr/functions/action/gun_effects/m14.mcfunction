...
playsound mgdr:m14.fire player @a[distance=..65] ~ ~ ~ 1000
playsound mgdr:m14.fire.mech player @a[distance=..10] ~ ~ ~ 1
playsound mgdr:m14.fire.bass player @a[distance=..55] ~ ~ ~ 10
