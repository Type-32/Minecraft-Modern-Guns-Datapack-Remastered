...
playsound mgdr:m1911.fire player @a[distance=..35] ~ ~ ~ 1000
playsound mgdr:m1911.fire.mech player @a[distance=..10] ~ ~ ~ 1
playsound mgdr:m1911.fire.bass player @a[distance=..25] ~ ~ ~ 1000
