...
playsound mgdr:cbr27.fire.mech player @a[distance=..10,tag=!haveSupressor] ~ ~ ~ 1
...
playsound mgdr:cbr27.sup_fire player @a[distance=..20,tag=haveSupressor] ~ ~ ~ 5
playsound mgdr:cbr27.sup_fire.mech player @a[distance=..5,tag=haveSupressor] ~ ~ ~ 1

playsound mgdr:cbr27.fire.bass player @a[distance=..38] ~ ~ ~ 100
