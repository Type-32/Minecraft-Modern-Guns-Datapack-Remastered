...
execute anchored eyes run function mgdr:rays/mp5
tag @s remove firing
...
execute as @s run playsound mgdr:mp5.fire voice @a[distance=..30] ~ ~ ~ 10
...
execute if score @s mp5.ammo matches ..0 at @s run playsound mgdr:common.empty player @s
