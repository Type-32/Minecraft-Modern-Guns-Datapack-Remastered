...
execute if score noRecoil mgdr.gamerule matches ..0 run tp @s ~ ~ ~ ~ ~-3
execute if score infiniteAmmo mgdr.gamerule matches ..0 run scoreboard players remove @s[gamemode=!creative] m1911.ammo 1
