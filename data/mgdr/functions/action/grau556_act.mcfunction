...
execute as @s[tag=!Kilowatt] anchored eyes run function mgdr:rays/grau556
execute as @s[tag=Kilowatt] anchored eyes run function mgdr:rays/grau556_kilowatt
tag @s remove firing
...
execute as @s[tag=Kilowatt] run playsound mgdr:grau556.kilowatt.fire voice @a[distance=..13] ~ ~ ~ 10
...
execute if score @s grau_kilo.ammo matches ..0 at @s run playsound mgdr:common.empty player @s
