...
execute as @s run playsound mgdr:vsg6t.fire voice @a[distance=..40] ~ ~ ~ 1000
...
execute if score @s vsg6t.ammo matches ..0 at @s run playsound mgdr:common.empty player @s
