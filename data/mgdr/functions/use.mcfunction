...
## AS-VAL
execute as @a[tag=holdingASVAL,scores={usedCarrotPol=1..},tag=!gunDisabled] at @s run function mgdr:use/asval
...
execute as @a[tag=holdingSIG716,tag=!gunDisabled,scores={fireDelay=1,sig716.fm=2}] unless score @s sig716.ammo matches ..0 at @s run function mgdr:action/sig716_act
...
## SIG-75-T
execute as @a[tag=holdingSIG75T,scores={usedCarrotPol=1..},tag=!gunDisabled] at @s run function mgdr:use/sig75t
...
## MP-7
execute as @a[tag=holdingMP7,scores={usedCarrotPol=1..},tag=!gunDisabled] at @s run function mgdr:use/mp7
#execute as @a[tag=holdingMP7,tag=!gunDisabled,scores={fireDelay=1,mp7.fm=1}] unless score @s mp7.ammo matches ..0 at @s run function mgdr:action/mp7_act
...
#execute as @a[tag=holdingMP7,tag=!gunDisabled,scores={fireDelay=3,mp7.fm=1}] unless score @s mp7.ammo matches ..0 at @s run function mgdr:action/mp7_act

## MP-5
execute as @a[tag=holdingMP5,scores={usedCarrotPol=1..},tag=!gunDisabled] at @s run function mgdr:use/mp5
...
## MP-5-T
execute as @a[tag=holdingMP5T,scores={usedCarrotPol=1..},tag=!gunDisabled] at @s run function mgdr:use/mp5t
...
## CZ-117
execute as @a[tag=holdingCZ117,scores={usedCarrotPol=1..},tag=!gunDisabled] at @s run function mgdr:use/cz117
...
## M-14
execute as @a[tag=holdingM14,scores={usedCarrotPol=1..},tag=!gunDisabled] at @s run function mgdr:use/m14

## M-1911
execute as @a[tag=holdingM1911,scores={usedCarrotPol=1..},tag=!gunDisabled] at @s run function mgdr:use/m1911

## M-17
execute as @a[tag=holdingM17,scores={usedCarrotPol=1..},tag=!gunDisabled] at @s run function mgdr:use/m17

## CBS-5
execute as @a[tag=holdingCBS5,scores={usedCarrotPol=1..}] at @s run function mgdr:use/cbs5

## MP-40
execute as @a[tag=holdingMP40,scores={usedCarrotPol=1..},tag=!gunDisabled] at @s run function mgdr:use/mp40
...
## STG-44
execute as @a[tag=holdingSTG44,scores={usedCarrotPol=1..},tag=!gunDisabled] at @s run function mgdr:use/stg44
...
## Type-2A
execute as @a[tag=holdingType2A,scores={usedCarrotPol=1..},tag=!gunDisabled] at @s run function mgdr:use/type2a
...
execute as @a[tag=holdingVSG15,scores={usedCarrotPol=1..},tag=!gunDisabled] at @s run function mgdr:use/vsg15
...
## Volkssturmgewehr 6T
execute as @a[tag=holdingVSG6T,scores={usedCarrotPol=1..},tag=!gunDisabled] at @s run function mgdr:use/vsg6t
...
## Vec-9 Fennec
execute as @a[tag=holdingVec9,scores={fireDelay=4..,usedCarrotPol=1..},tag=!gunDisabled] at @s run function mgdr:use/vec9
...
## AUG Para
execute as @a[tag=holdingAUGPara,scores={usedCarrotPol=1..},tag=!gunDisabled] at @s run function mgdr:use/augpara
...
#execute as @a[tag=holdingController,scores={usedCarrotPol=1..,plane.mode=0},x_rotation=-90..80] at @s run function mgdr:use/controller_func
#execute as @a[tag=holdingController,scores={fireDelay=2,plane.mode=0},x_rotation=-90..80] at @s run function mgdr:use/controller_func
