...
execute if entity @s[tag=!Kilowatt] if score @s grau.ammo matches ..0 at @s run playsound mgdr:others.empty player @s
...
execute if entity @s[tag=Kilowatt] if score @s grau_kilo.ammo matches ..0 at @s run playsound mgdr:others.empty player @s
