...
execute if score @s fireDelay matches 2 if score @s mp7.fm matches 1 unless score @s mp7.ammo matches ..0 run scoreboard players operation /player.lastFiredUID mgdr.gamerule = @s mgdr.pid
execute if score @s fireDelay matches 2 if score @s mp7.fm matches 1 unless score @s mp7.ammo matches ..0 run scoreboard players operation /player.lastFiredWeaponUID mgdr.gamerule = @s mgdr.weaponUID
