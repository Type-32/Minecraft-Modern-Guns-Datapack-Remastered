execute if entity @s[scores={009.fullMag=..0}] if score @s cbr27a1.reload matches 0 run tellraw @s {"translate":"mgdr.translate.ammo.no_reload","color":"red"}
...
execute if entity @s[scores={cbr27a1.reload=..4}] at @s run title @s actionbar ["",{"translate":"mgdr.translate.ammo.reloading","color":"red"}]
...
execute if entity @s[scores={cbr27a1.reload=4},tag=!switchedMag] if score @s 009.fullMag matches 1.. run function mgdr:reload/action/009mm_switch
