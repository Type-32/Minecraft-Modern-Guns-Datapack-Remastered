execute if entity @s[scores={762.fullMag=..0}] if score @s cbs5.reload matches 0 run tellraw @s {"translate":"mgdr.translate.ammo.no_reload","color":"red"}
...
execute if entity @s[scores={cbs5.reload=..4}] at @s run title @s[scores={new_ui=1}] actionbar ["",{"text":"\uEff8\uEff9","color": "red"}]
