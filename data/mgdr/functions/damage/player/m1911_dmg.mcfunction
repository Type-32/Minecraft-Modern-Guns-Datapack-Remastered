...
scoreboard players operation .weapon_damage_temp mgdr.gamerule = weapon.damage.m1911 mgdr.gamerule
...
scoreboard players set @a[tag=PlayerDamageSource,scores={mgdr.weaponUID=12}] whiteHit 0

playsound minecraft:ui.button.click voice @a[tag=PlayerDamageSource,scores={mgdr.weaponUID=12}] ~ ~1000 ~ 1000000000 2
