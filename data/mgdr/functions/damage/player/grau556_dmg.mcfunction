...
scoreboard players operation .weapon_damage_temp mgdr.gamerule = weapon.damage.grau556 mgdr.gamerule
...
scoreboard players set @a[tag=firingMarkerDetect,scores={mgdr.weaponUID=9}] whiteHit 0

playsound minecraft:ui.button.click voice @a[tag=firingMarkerDetect,scores={mgdr.weaponUID=9}] ~ ~1000 ~ 1000000000 2
