...
scoreboard players operation .weapon_damage_temp mgdr.gamerule = weapon.damage.vec9 mgdr.gamerule
...
scoreboard players set @a[tag=firingMarkerDetect,scores={mgdr.weaponUID=18}] whiteHit 0

playsound minecraft:ui.button.click voice @a[tag=firingMarkerDetect,scores={mgdr.weaponUID=18}] ~ ~1000 ~ 1000000000 2
