...
scoreboard players operation .weapon_damage_temp mgdr.gamerule = weapon.damage.m17 mgdr.gamerule
...
scoreboard players set @a[tag=firingMarkerDetect,scores={mgdr.weaponUID=11}] whiteHit 0

playsound minecraft:ui.button.click voice @a[tag=firingMarkerDetect,scores={mgdr.weaponUID=11}] ~ ~1000 ~ 1000000000 2
