...
scoreboard players set @a[tag=firingMarkerDetect,scores={mgdr.weaponUID=14}] whiteHit 0

playsound minecraft:ui.button.click voice @a[tag=firingMarkerDetect,scores={mgdr.weaponUID=14}] ~ ~1000 ~ 1000000000 2
