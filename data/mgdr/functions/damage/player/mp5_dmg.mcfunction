...
scoreboard players operation .weapon_damage_temp mgdr.gamerule = weapon.damage.mp5 mgdr.gamerule
...
scoreboard players set @a[tag=PlayerDamageSource,scores={mgdr.weaponUID=13}] whiteHit 0

playsound minecraft:ui.button.click voice @a[tag=PlayerDamageSource,scores={mgdr.weaponUID=13}] ~ ~1000 ~ 1000000000 2
