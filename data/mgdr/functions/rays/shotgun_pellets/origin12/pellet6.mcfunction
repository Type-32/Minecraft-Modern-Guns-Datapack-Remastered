...
execute positioned ^-.08 ^ ^1 unless block ~ ~ ~ #mgdr:penetrable run particle minecraft:crit ~ ~ ~ .01 .01 .01 1.8 5 force
execute positioned ^-.08 ^ ^1 unless block ~ ~ ~ #mgdr:penetrable run playsound mgdr:others.solid_bullet_impact block @a[distance=..11] ~ ~ ~ 10
execute positioned ^-.08 ^ ^1 run function mgdr:func/ray_reset
execute positioned ^-.08 ^ ^1 if block ~ ~ ~ #mgdr:penetrable run function mgdr:rays/shotgun_pellets/origin12/pellet6
