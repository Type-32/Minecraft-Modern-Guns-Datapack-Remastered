data modify storage mgdr:temp Item set value {id:"minecraft:clock",Count:1b,tag:{Tags:["molten_synthetic_copper","molten_bucket"],display:{Name:'{"translate":"mgdr.item.molten_synthetic_copper","italic":false}'},CustomModelData:214002}}
...
execute if data storage mgdr:temp outputItems[{tag:{Tags:["molten_synthetic_copper"]}}] store result score .inGridMoltenBucketCount mgdrCrafting run data get storage mgdr:temp outputItems[{tag:{Tags:["molten_synthetic_copper"]}}].Count
execute if data storage mgdr:temp outputItems[{tag:{Tags:["molten_synthetic_copper"]}}] store result score .inGridMoltenBucketSlot mgdrCrafting run data get storage mgdr:temp outputItems[{tag:{Tags:["molten_synthetic_copper"]}}].Slot
execute if data storage mgdr:temp outputItems[{tag:{Tags:["molten_synthetic_copper"]}}] run scoreboard players operation .outputItemCount mgdrCrafting += .inGridMoltenBucketCount mgdrCrafting
execute if data storage mgdr:temp outputItems[{tag:{Tags:["molten_synthetic_copper"]}}] store result storage mgdr:temp Item.Slot byte 1 run scoreboard players get .inGridMoltenBucketSlot mgdrCrafting
...
execute unless data storage mgdr:temp outputItems[{tag:{Tags:["molten_synthetic_copper"]}}] run data modify storage mgdr:temp outputItems append from storage mgdr:temp Item
execute if data storage mgdr:temp outputItems[{tag:{Tags:["molten_synthetic_copper"]}}] store result storage mgdr:temp outputItems[{tag:{Tags:["molten_synthetic_copper"]}}].Count int 1 run scoreboard players get .outputItemCount mgdrCrafting
