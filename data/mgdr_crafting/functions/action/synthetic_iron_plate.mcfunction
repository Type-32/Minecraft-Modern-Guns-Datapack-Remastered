data modify storage mgdr:temp Item set value {id:"minecraft:clock",Count:1b,tag:{Tags:["synthetic_iron_plate","molded_plate"],display:{Name:'{"translate":"mgdr.item.synthetic_iron_plate","italic":false}'},CustomModelData:215101}}
...
execute if data storage mgdr:temp outputItems[{tag:{Tags:["synthetic_iron_plate"]}}] store result score .inGridMoldedIngotCount mgdrCrafting run data get storage mgdr:temp outputItems[{tag:{Tags:["synthetic_iron_plate"]}}].Count
execute if data storage mgdr:temp outputItems[{tag:{Tags:["synthetic_iron_plate"]}}] store result score .inGridMoldedIngotSlot mgdrCrafting run data get storage mgdr:temp outputItems[{tag:{Tags:["synthetic_iron_plate"]}}].Slot
execute if data storage mgdr:temp outputItems[{tag:{Tags:["synthetic_iron_plate"]}}] run scoreboard players operation .outputItemCount mgdrCrafting += .inGridMoldedIngotCount mgdrCrafting
execute if data storage mgdr:temp outputItems[{tag:{Tags:["synthetic_iron_plate"]}}] store result storage mgdr:temp Item.Slot byte 1 run scoreboard players get .inGridMoldedIngotSlot mgdrCrafting
...
execute unless data storage mgdr:temp outputItems[{tag:{Tags:["synthetic_iron_plate"]}}] run data modify storage mgdr:temp outputItems append from storage mgdr:temp Item
execute if data storage mgdr:temp outputItems[{tag:{Tags:["synthetic_iron_plate"]}}] store result storage mgdr:temp outputItems[{tag:{Tags:["synthetic_iron_plate"]}}].Count int 1 run scoreboard players get .outputItemCount mgdrCrafting
