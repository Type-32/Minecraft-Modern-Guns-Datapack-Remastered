data modify storage mgdr:temp Item set value {id:"minecraft:clock",Count:3b,tag:{Tags:["copper_plate"],display:{Name:'{"translate":"mgdr.item.copper_plate","italic":false}'},CustomModelData:212201}}
