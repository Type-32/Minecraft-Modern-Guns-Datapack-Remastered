data modify storage mgdr:temp Item set value {id:"minecraft:clock",Count:1b,tag:{Tags:["synthetic_copper_ingot","molded_ingot"],display:{Name:'{"translate":"mgdr.item.synthetic_copper_ingot","italic":false}'},CustomModelData:215002}}
...
execute if data storage mgdr:temp outputItems[{tag:{Tags:["synthetic_copper_ingot"]}}] store result score .inGridMoldedIngotCount mgdrCrafting run data get storage mgdr:temp outputItems[{tag:{Tags:["synthetic_copper_ingot"]}}].Count
execute if data storage mgdr:temp outputItems[{tag:{Tags:["synthetic_copper_ingot"]}}] store result score .inGridMoldedIngotSlot mgdrCrafting run data get storage mgdr:temp outputItems[{tag:{Tags:["synthetic_copper_ingot"]}}].Slot
execute if data storage mgdr:temp outputItems[{tag:{Tags:["synthetic_copper_ingot"]}}] run scoreboard players operation .outputItemCount mgdrCrafting += .inGridMoldedIngotCount mgdrCrafting
execute if data storage mgdr:temp outputItems[{tag:{Tags:["synthetic_copper_ingot"]}}] store result storage mgdr:temp Item.Slot byte 1 run scoreboard players get .inGridMoldedIngotSlot mgdrCrafting
...
execute unless data storage mgdr:temp outputItems[{tag:{Tags:["synthetic_copper_ingot"]}}] run data modify storage mgdr:temp outputItems append from storage mgdr:temp Item
execute if data storage mgdr:temp outputItems[{tag:{Tags:["synthetic_copper_ingot"]}}] store result storage mgdr:temp outputItems[{tag:{Tags:["synthetic_copper_ingot"]}}].Count int 1 run scoreboard players get .outputItemCount mgdrCrafting
