...
execute if score .succeedIndicator mgdrCrafting matches 3 unless data storage mgdr:temp data.Items[{id:"minecraft:raw_iron"}] run scoreboard players set .succeedIndicator mgdrCrafting 0
...
execute if score .succeedIndicator mgdrCrafting matches 3 run function mgdr_crafting:action/molten_liquids/molten_synthetic_iron
