...
execute if score .succeedIndicator mgdrCrafting matches 5 unless data storage mgdr:temp data.Items[{tag:{Tags:["synthetic_copper_ingot"]}}] run scoreboard players set .succeedIndicator mgdrCrafting 0
...
execute if score .succeedIndicator mgdrCrafting matches 5 run function mgdr_crafting:action/synthetic_copper_plate
