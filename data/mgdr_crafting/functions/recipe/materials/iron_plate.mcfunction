...
execute if score .succeedIndicator mgdrCrafting matches 1 unless data storage mgdr:temp data.Items[{Slot:3b,id:"minecraft:gold_ingot"}] run scoreboard players set .succeedIndicator mgdrCrafting 0
execute if score .succeedIndicator mgdrCrafting matches 1 unless data storage mgdr:temp data.Items[{Slot:4b,id:"minecraft:gold_ingot"}] run scoreboard players set .succeedIndicator mgdrCrafting 0
execute if score .succeedIndicator mgdrCrafting matches 1 unless data storage mgdr:temp data.Items[{Slot:5b,id:"minecraft:gold_ingot"}] run scoreboard players set .succeedIndicator mgdrCrafting 0
...
execute if score .succeedIndicator mgdrCrafting matches 1 run function mgdr_crafting:action/iron_plate
