...
execute as @e[tag=workbench,tag=mp7] at @s run schedule function mgdr_crafting:action/mp7 3s
execute as @e[tag=workbench,tag=!mp7] at @s run schedule clear mgdr_crafting:action/mp7
