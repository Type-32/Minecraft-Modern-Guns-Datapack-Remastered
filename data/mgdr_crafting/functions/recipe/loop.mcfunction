...
execute if score .succeedIndicator mgdrCrafting matches 0 run function mgdr_crafting:recipe/materials/iron_plate
...
execute if score .succeedIndicator mgdrCrafting matches 0 run function mgdr_crafting:recipe/materials/copper_plate
